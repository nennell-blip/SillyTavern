...
export const ModelSelector = {
    ...
    initialize() {
        ...
        if (!document.querySelector('link[href*="model-selector.css"]')) {
            ...
            link.rel = 'stylesheet';
            link.href = 'scripts/nemo/features/connection/model-selector.css';
        ...
        if (!document.querySelector('link[href*="pipeline-settings.css"]')) {
            ...
            pipeLink.href = 'scripts/nemo/features/connection/pipeline-settings.css';
        ...
        if (!document.querySelector('link[href*="proxy-manager.css"]')) {
            ...
            proxyLink.href = 'scripts/nemo/features/connection/proxy-manager.css';
