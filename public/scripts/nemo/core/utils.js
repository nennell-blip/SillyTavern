 ...
 * Use this instead of hardcoding 'scripts/nemo/...' everywhere.
...
export function getExtensionPath(relativePath = '') {
    // Stage A port: nemo code lives at /scripts/nemo now, not under the
    // old extensions/third-party path. Keep NEMO_EXTENSION_NAME as a
    // settings-namespace key but build URLs against the new location.
    return `scripts/nemo/${relativePath}`;
}
